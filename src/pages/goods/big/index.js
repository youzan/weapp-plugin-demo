...
Page({
  data: {
    ...
    nodes: '&lt;goods<br><span style="margin-left: 10px;"></span>'
      ...
      + 'layout="{{ 0 }}"<br><span style="margin-left: 10px;"></span>'
      + 'buy-button-type="{{ 2 }}"<br><span style="margin-left: 10px;"></span>'
      + 'show-corner-mark<br><span style="margin-left: 10px;"></span>'
      + 'corner-mark-type="{{ 0 }}"<br>/&gt;',
