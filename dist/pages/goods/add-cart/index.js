...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/pages/goods/add-cart/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/pages/goods/add-cart/index.js":
/*!*******************************************!*\
  !*** ./src/pages/goods/add-cart/index.js ***!
  \*******************************************/
...
Page({
  data: {
    alias: '102276278',
    nodes: '&lt;goods<br><span style="margin-left: 10px;"></span>' + 'app-id="wxf11c5910cb729a82"<br><span style="margin-left: 10px;"></span>' + 'shop-id="{{ 45694034 }}"<br><span style="margin-left: 10px;"></span>' + 'layout="{{ 0 }}"<br>/&gt;',
    extraData: {
      config: {
        scene: {
          default: {
  ...
  handleBuy: function handleBuy(detail) {
